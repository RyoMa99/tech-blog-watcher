...
テックブログ(80サイト)の新着記事を毎朝チェックして通知するシステム。
...
| `adapters/` | フィードがない/特殊なサイト用アダプタ(wantedly / google_ja / anthropic_news / claude_blog / cursor_blog / notion_tech / discord_engineering / shopify / twitch / uber / bytedance_seed) |
